...
from nerfstudio.models.splatfacto_2dgs import Splatfacto2DGSModelConfig
...
descriptions = {
    ...
    "splatfacto-2dgs": "Splatfacto with 2D Gaussian Splatting.",
}
...
method_configs["splatfacto-2dgs"] = TrainerConfig(
